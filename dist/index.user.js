...
(function () {
  ...
  var MESSAGES = {
    ...
    error: {
      basic: "Error",
      containerNotFound: "Nie znaleziono kontenera ".concat(
        IDS.form,
        ". Skrypt zosta\u0142 wstrzymany."
      ),
    },
  };
  ...
  var getProjectList = function getProjectList() {
    try {
      ...
      projects =
        (_JSON$parse = JSON.parse(projectsString)) !== null &&
        _JSON$parse !== void 0
          ? _JSON$parse
          : [].concat(DEFAULT_PROJECT_LIST);
    } catch (e) {
    ...
    var listElements = data.map(function (el, index) {
      ...
      var message =
        status === 201
          ...
          : (_ref7 =
              (_el$errorMessages$ = el.errorMessages[0]) !== null &&
              _el$errorMessages$ !== void 0
                ? _el$errorMessages$
                : (_el$errors = el.errors) === null || _el$errors === void 0
                ? void 0
                : _el$errors.name) !== null && _ref7 !== void 0
          ? _ref7
          : MESSAGES.error.basic;
      var lozengeClassName =
      ...
      return "\n      <li>\n        <span>"
        ...
        .concat(lozengeClassName, '">')
        .concat(
          status,
          '</span>\n        <span style="font-size: 10px; line-height: 1; color: var('
        )
        .concat(messageColor, ')"> - ')
        .concat(message, "</span>\n      </li>");
    });
                ...
                return new Promise(function (resolve, reject) {
                  ...
                  var setIntervalId = setInterval(function () {
                    ...
                    if (form) {
                      ...
                      window.console.info(
                        "%c ".concat(MESSAGES.containerFound),
  ...
  var filterFixVersionRows = function filterFixVersionRows(rows) {
    var filteredRows = _toConsumableArray(rows).filter(function (row) {
      ...
      return anchor === null || anchor === void 0
        ? void 0
        : anchor.textContent.match(/^FrontPortal-(\d)(\.\d{0,3})?$/);
    });
    return filteredRows;
  };
  var getVersionIds = function getVersionIds(_ref13) {
    ...
    return projectsVersions.map(function (projectVersions) {
      ...
      return (_projectVersions$valu = projectVersions.values.find(function (
        _ref14
      ) {
        var name = _ref14.name;
        return name === targetVersionName;
      })) === null || _projectVersions$valu === void 0
        ? void 0
        : _projectVersions$valu.id;
    });
  };
  var archiveVersions = function archiveVersions(versionIds) {
    return Promise.allSettled(
      versionIds.map(function (id) {
        if (!id) return;
        var options = {
          method: "PUT",
          headers: {
    ...
    var listElements = archiveData.map(function (el, index) {
      ...
      switch (status) {
        ...
        default:
          message =
            (_ref16 =
              (_el$errorMessages$2 = el.errorMessages[0]) !== null &&
              _el$errorMessages$2 !== void 0
                ? _el$errorMessages$2
                : (_el$errors2 = el.errors) === null || _el$errors2 === void 0
                ? void 0
                : _el$errors2.name) !== null && _ref16 !== void 0
              ? _ref16
              : MESSAGES.error.basic;
          break;
      }
  ...
  var handleArchiveBtnClick = /*#__PURE__*/ (function () {
    var _ref18 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee4(_ref17) {
        var e,
          archiveButton,
          targetProjects,
          targetVersionName,
          projectsVersionsResponses,
          projectsVersions,
          versionIds,
          archiveResponses,
          archiveData,
          ...
          while (1)
            switch ((_context4.prev = _context4.next)) {
              ...
              case 5:
                ...
                _context4.next = 8;
                return Promise.all(
                  projectsVersionsResponses.map(function (resp) {
                    return resp.value.json();
                  })
                );
              case 8:
              ...
              case 12:
                ...
                _context4.next = 15;
                return Promise.all(
                  archiveResponses.map(function (resp) {
              ...
              case 15:
                ...
                displayMessage({
                  ...
                  title: "".concat(
                    targetVersionName,
                    " - response status of other projects (archiving)"
                  ),
                  content: listElements.join(""),
                });
                archiveButton.click();
  ...
  var fetchProjectsVersions = function fetchProjectsVersions(targetProjects) {
    return Promise.allSettled(
      targetProjects.map(function (_ref20) {
  ...
  var addArchiveButtons = function addArchiveButtons() {
    versionTableRows.forEach(function (row) {
      ...
      var buttonPanel =
        row === null || row === void 0
          ? void 0
          : row.querySelector(SELECTORS.versionTableRowPanel);
      var archiveButton =
        buttonPanel === null || buttonPanel === void 0
          ? void 0
          : buttonPanel.querySelector(SELECTORS.versionTableRowArchiveBtn);
      var archiveForMultipleProjectBtn =
        buttonPanel === null || buttonPanel === void 0
          ? void 0
          : buttonPanel.querySelector(SELECTORS.archiveForMultipleProjectBtn);
      if (!archiveButton || archiveForMultipleProjectBtn) return;
      var archiveButtonContainer =
        archiveButton === null || archiveButton === void 0
          ? void 0
          : archiveButton.parentNode;
  ...
  var handleVersionTableBodyUpdate = debounce(
  ...
  var listenForTableChanges = function listenForTableChanges() {
    var versionsTableBody = versionsTable.querySelector(
            ...
            while (1)
              switch ((_context7.prev = _context7.next)) {
                ...
                case 6:
                  ...
                  console.error(
                    "Nie znaleziono rekordów z fix version w tabeli"
                  );
                case 10:
                case "end":
